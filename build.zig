...
pub fn build(b: *std.Build) void {
    ...
    // Add httpz as a dependency to the executable.
    ...
    // Add zdt as a dependency to the executable.
    ...
    // Add mustache as a dependency to the executable.
    ...
    const check_step = b.step("check", "Make sure the code compiles and lints");
